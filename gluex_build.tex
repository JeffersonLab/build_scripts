...
dependent package (sim-recon) will usually have listed the prequisite
(hdds) with the {\tt home} attribute in its (sim-recon's) prerequisite
file and will have neither a {\tt version} or a {\tt url} attribute
defined. In that case, a warning will be issued noting the absence of
both {\tt version} and {\tt url} attributes.
