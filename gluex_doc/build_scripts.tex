...
At JLab, \bs{} is installed in {\tt /group/halld/Software/build\_scripts}. You can start by defining an environment variable:
\begin{center}
...
\subsubsection{Simple Environment Set Up}\label{section:simple-setup}
...
follow the steps in Section~\ref{section:simple-setup} that are
designated for gluex\_install builds.
